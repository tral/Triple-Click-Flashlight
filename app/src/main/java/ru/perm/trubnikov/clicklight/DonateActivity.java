    ...
    public void tryToPurchase(String productId) {
        if (readyToPurchase) {
            ...
            if (bp.isPurchased(productId)) {
                Utils.ShowToast(DonateActivity.this, R.string.donation_already_purchased, Toast.LENGTH_LONG);
            } else {
                bp.purchase(DonateActivity.this, productId);
            }
        } else {
            Utils.ShowToast(DonateActivity.this, R.string.donation_billing_not_ready, Toast.LENGTH_LONG);
        }
    }
